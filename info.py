...
# Bot information
API_ID = environ.get('API_ID', '24164758')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1321078922')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001968420565').split()]
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001764973106').split()]
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001724209803')
...
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', 'https://t.me/movieriqvestatoz')
...
if len(DATABASE_URL) == 0:
    ...
    exit()
DATABASE_NAME = environ.get('DATABASE_NAME', "rayyan")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Files')

# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/faheem786786')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/faheem786786')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001924749763")
if len(BIN_CHANNEL) == 0:
    logging.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://lisab-c573533c66e8.herokuapp.com/")
if len(URL) == 0:
